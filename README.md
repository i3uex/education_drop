...
1. Via Docker **(Recommended option for no worries by dependencies of Operative System)**:
   ...
   2. Make a pull of docker image by command "docker pull ghcr.io/i3uex/education_drop/ed_exp_dv:1.1"
   3. Run docker image by command "docker run ghcr.io/i3uex/education_drop/ed_exp_dv:1.1"
